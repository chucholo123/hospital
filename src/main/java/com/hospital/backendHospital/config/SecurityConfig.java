    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.PATCH, "/api/v1/patients/{id}/desactivate").hasRole("ADMIN");
                    ...
                    http.requestMatchers(HttpMethod.PATCH, "/api/v1/doctors/{id}/update").hasRole("DOCTOR");
                    http.requestMatchers(HttpMethod.PATCH, "/api/v1/doctors/{id}/desactive").hasRole("ADMIN");
